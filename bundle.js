...
var _modulesMortgageCalculator = require('./modules/MortgageCalculator');

var _modulesMortgageCalculator2 = _interopRequireDefault(_modulesMortgageCalculator);
...
},{"./modules/Header":3,"./modules/MortgageCalculator":4,"react":161}],2:[function(require,module,exports){
"use strict";
...
exports['default'] = _react2['default'].createClass({
    displayName: 'Header',
    // ES6: new object literals notation (function)
    render: function render() {
        return _react2['default'].createElement(
            'header',
            null,
...
var _AmortizationChart = require('./AmortizationChart');
...
exports['default'] = _react2['default'].createClass({
    ...
    render: function render() {
        ...
        var _mortgage$calculatePayment = mortgage.calculatePayment(this.state.principal, this.state.years, this.state.rate);

        var monthlyPayment = _mortgage$calculatePayment.monthlyPayment;
        var amortization = _mortgage$calculatePayment.amortization;
...
},{"./AmortizationChart":2,"./mortgage":5,"react":161}],5:[function(require,module,exports){
"use strict";
